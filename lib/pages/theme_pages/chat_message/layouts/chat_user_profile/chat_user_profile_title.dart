...
class ChatUserProfileTitle extends StatelessWidget {
  ...
  const ChatUserProfileTitle(
      {Key? key, this.isSliverAppBarExpanded = false,this.isBroadcast = false, this.name, this.image})
      : super(key: key);
                ...
                child: isBroadcast ? Container(
                    ...
                    decoration: ShapeDecoration(
                        ...
                        image:isBroadcast ?DecorationImage(
                            fit: BoxFit.fitWidth,
                            image: AssetImage(imageAssets.user)) : DecorationImage(
                            fit: BoxFit.fitWidth,
                            image: NetworkImage(image!))),
                    child: SvgPicture.asset(svgAssets.audio)): CachedNetworkImage(
                    imageUrl: image!,
